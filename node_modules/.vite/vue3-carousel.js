...
var Carousel = defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    function initDefaultConfigs() {
      ...
      defaultConfig = Object.assign(Object.assign({}, defaultConfig), { settings: void 0, breakpoints: void 0 });
    }
    ...
    function updateSlidesData() {
      ...
      currentSlide.value = slidesCount.value <= 0 ? 0 : Math.min(slidesCount.value - 1, currentSlide.value);
    }
    ...
    function prev() {
      let prevSlide2 = currentSlide.value - config.itemsToScroll;
      if (!config.wrapAround) {
        prevSlide2 = Math.max(prevSlide2, 0);
      }
      slideTo(prevSlide2);
    }
    ...
    watchEffect(() => {
      ...
      const currentSlideUpdated = props.modelValue !== void 0 && currentSlide.value !== props.modelValue;
